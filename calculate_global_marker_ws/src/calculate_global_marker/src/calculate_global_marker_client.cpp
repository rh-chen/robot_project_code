...
#include <robust_goal/RobustGoalAction.h>
...
int main(int argc, char** argv)
{
	...
	ros::ServiceClient cgp_client = n.serviceClient<calculate_global_marker::GetMarkerGlobalPose>("/calculate_marker_global_pose");

	ros::Rate loop_rate(20);
//while(ros::ok())
{
	calculate_global_marker::GetMarkerGlobalPose cgp_srv;
