...
void LabelingCvSeq::LabelSquares(IplImage* image, bool visualize)
{
    ...
    cvAdaptiveThreshold(gray_filter, bw, 255, CV_ADAPTIVE_THRESH_MEAN_C, CV_THRESH_BINARY_INV, thresh_param1, thresh_param2);
    ...
    while(contours)
    {
        ...
        CvSeq* result = cvApproxPoly(contours, sizeof(CvContour), storage,
                                     CV_POLY_APPROX_DP, cvContourPerimeter(contours)*0.03, 0 ); // TODO: Parameters?
