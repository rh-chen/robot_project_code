...
public:
	...
	/// 
	INUSTREAMS_API void Update(uint64_t ServiceTimestamp, uint64_t StreamTimestamp, uint64_t Timestamp,
		unsigned int FrameIndex, bool Valid, InuDev::CInuError error);
