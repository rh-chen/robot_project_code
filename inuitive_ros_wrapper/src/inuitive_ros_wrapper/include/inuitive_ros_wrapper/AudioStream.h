...
namespace InuDev 
{
    ...
    public:
        ...
        typedef std::function<void(std::shared_ptr<CAudioStream> , const CGeneralFrame&,  CInuError)> CallbackFunction;
        ...
        virtual CInuError GetFrame(CGeneralFrame& oaudioFrame, unsigned int iTimeout = FPS_BASED_TIMEOUT) = 0;
