...

{
  ...
  connect(deposited_material_width_, SIGNAL(valueChanged(double)), this, SIGNAL(valueChanged()));
  connect(contours_filtering_tolerance_, SIGNAL(valueChanged(double)), this, SIGNAL(valueChanged()));
  connect(slicing_direction_x_, SIGNAL(valueChanged(double)), this, SIGNAL(valueChanged()));
  connect(slicing_direction_y_, SIGNAL(valueChanged(double)), this, SIGNAL(valueChanged()));
  connect(slicing_direction_z_, SIGNAL(valueChanged(double)), this, SIGNAL(valueChanged()));
...
std::string DonghongDingWidget::fileExtension(const std::string full_path)
{
