...
TEST(TestSuite, testSendFirstTrajectoryFirstParameters)
{
  ...
  srv.request.cylinder_size = 0.01;
  srv.request.wire_size = 5;
  srv.request.axis_size = 0.2;
  srv.request.display_mode = 2;
...
// Send and wrong value in display_mode
