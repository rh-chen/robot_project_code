...
LaserScanToPointCloud::LaserScanToPointCloud(){
	...
	laser_scan_sub_ = node_hand_.subscribe("/scan", 10, &LaserScanToPointCloud::laserScanCallback, this);

	//=======================================================================
	// Publishers
	//=======================================================================
	pc_pub_ = node_hand_.advertise<sensor_msgs::PointCloud2>("pc_from_scan", 10, true);
