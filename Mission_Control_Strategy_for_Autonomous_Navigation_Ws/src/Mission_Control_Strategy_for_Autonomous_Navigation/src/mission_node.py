...
class MissionHandler:
    ...
    def frontierCallback(self, msg):
        ...
        self.frontiers = None
        for i in range(2, msg.info.height - 2):
            for j in range(2, msg.info.width - 2):
                ...
                if  (msg.data[w*i + j - 1] == 2 and msg.data[w*(i - 1) + j] == 1) or \
                        ...
                        (msg.data[w*(i + 1) + j] == 2 and msg.data[w*i + j - 1] == 1) or \
                        (msg.data[w*(i + 1) + j] == 1 and msg.data[w*i + j - 1] == 2) or \
                        (msg.data[w*i + j - 1] == 0 and msg.data[w*(i - 1) + j] == 2) or \
                        (msg.data[w*i + j - 1] == 2 and msg.data[w*(i - 1) + j] == 0) or \
                        (msg.data[w*i + j + 1] == 2 and msg.data[w*(i - 1) + j] == 0) or \
                        (msg.data[w*i + j + 1] == 0 and msg.data[w*(i - 1) + j] == 2) or \
                        (msg.data[w*(i + 1) + j] == 2 and msg.data[w*i + j + 1] == 0) or \
                        (msg.data[w*(i + 1) + j] == 0 and msg.data[w*i + j + 1] == 2) or \
                        (msg.data[w*(i + 1) + j] == 2 and msg.data[w*i + j - 1] == 0) or \
                        (msg.data[w*(i + 1) + j] == 0 and msg.data[w*i + j - 1] == 2):
