...
*/
        ...
        if((rcv_buf[0] & 0XFF) == 0XAA &&(rcv_buf[1] & 0XFF) == 0XAA) {
            ...
            accel_x_real = (double)(accel_x_temp) / 100;
            accel_y_real = (double)(accel_y_temp) / 100;
            accel_z_real = (double)(accel_z_temp) / 100;
            gyro_x_real = (double)(gyro_x_temp) / 1000 * GRAVITY;
            gyro_y_real = (double)(gyro_y_temp) / 1000 * GRAVITY;
            gyro_z_real = (double)(gyro_z_temp) / 1000 * GRAVITY;
