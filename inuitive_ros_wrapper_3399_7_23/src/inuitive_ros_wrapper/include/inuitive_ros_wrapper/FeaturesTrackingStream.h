...
namespace InuDev 
{
    ...
    public:
        ...
        typedef std::function<void(std::shared_ptr<CFeaturesTrackingStream> , const CFeaturesTrackingFrame&,  CInuError)> CallbackFunction;
        ...
        virtual CInuError GetFrame(CFeaturesTrackingFrame& oFeaturesTrackingFrame, unsigned int iTimeout = FPS_BASED_TIMEOUT) = 0;
