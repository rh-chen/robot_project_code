...
namespace InuDev 
{
    ...
    struct CIioChannelInfo
   {
    ...
    public:
        ...
        //typedef std::function<void(std::shared_ptr<CImuStream> , const CGeneralFrame&,  CInuError)> CallbackFunction;
        ...
        typedef std::function<void(std::shared_ptr<CImuStream> , const CImuFrame&,  CInuError)>     CallbackFunction;
        ...
        virtual CInuError GetFrame(CImuFrame& oImuFrame, unsigned int iTimeout = FPS_BASED_TIMEOUT) = 0;
